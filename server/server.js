// entry point to our backend app 

require("dotenv").config(); // import dot env to manage different environment variables 
...
//middleware that the infromation in the body of the request and attach to our request object 
app.use(cors());
...
const port = process.env.PORT || 3001; // || gives a back up incase the variable is deleted 
app.listen(port, () => {
